...
public class DrillSqlOperator extends SqlFunction {
  ...
  public DrillSqlOperator(String name, int argCount, boolean isDeterministic) {
    this(name, null, isDeterministic);
  }

  public DrillSqlOperator(String name, int argCount, MajorType returnType, boolean isDeterministic) {
    super(new SqlIdentifier(name, SqlParserPos.ZERO), null, null, null, null,
        SqlFunctionCategory.USER_DEFINED_FUNCTION);
    this.isDeterministic = isDeterministic;
    this.functions = Lists.newArrayList();
  }

  public DrillSqlOperator(String name, List<DrillFuncHolder> functions, boolean isDeterministic) {
    super(new SqlIdentifier(name, SqlParserPos.ZERO), null, null, null, null,
        SqlFunctionCategory.USER_DEFINED_FUNCTION);
  ...
  public SqlOperandCountRange getOperandCountRange() {
    return super.getOperandCountRange();
  }
  ...
  public String getAllowedSignatures(String opNameToUse) {
    return super.getAllowedSignatures(opNameToUse);
  }
}
