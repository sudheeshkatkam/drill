...
public final class FastSaslServerFactory implements SaslServerFactory {
  ...
  private static final class FastSaslServerFactoryHolder {
    static final FastSaslServerFactory INSTANCE = new FastSaslServerFactory();

    // prevent instantiation
    private FastSaslServerFactoryHolder() {
    }
  }

  public static FastSaslServerFactory getInstance() {
    return FastSaslServerFactoryHolder.INSTANCE;
  }

  // package private
  @VisibleForTesting
  static void reload() {
    FastSaslServerFactoryHolder.INSTANCE.refresh();
  }
