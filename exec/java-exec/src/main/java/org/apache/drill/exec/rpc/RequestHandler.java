 ...
 * @param <Connection>
 */
public interface RequestHandler<Connection extends RemoteConnection> {
   ...
   * @throws RpcException
   */
  void handle(Connection connection, int rpcType, ByteBuf pBody, ByteBuf dBody, ResponseSender sender)
      throws RpcException;
