  ...
  public static String deriveKerberosName(final ConnectionParams params) {
    ...
    if (serviceHostnameProp != null) {
      ...
      if (serviceHostnameDefault != null) {
        ...
        try {
          principalBuilder.append(InetAddress.getLocalHost().getCanonicalHostName());
        } catch (final UnknownHostException e) {
          throw new IllegalArgumentException("Cannot derive Kerberos name of Drill service.", e);
        }
      }
    }
    principalBuilder.append("@");
