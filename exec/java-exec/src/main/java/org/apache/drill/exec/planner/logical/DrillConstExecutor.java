...
public class DrillConstExecutor implements RelOptPlanner.Executor {
  ...
  public static ImmutableMap<SqlTypeName, TypeProtos.MinorType> CALCITE_TO_DRILL_TYPE_MAPPING =
    ImmutableMap.<SqlTypeName, TypeProtos.MinorType> builder()
        ...
        //.put(SqlTypeName.DECIMAL, TypeProtos.MinorType.DECIMAL18) // ADD NOTE!!!
