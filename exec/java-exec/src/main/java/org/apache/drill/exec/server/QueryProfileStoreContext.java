...
//  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(QueryProfileStoreContext.class);
  ...
  public QueryProfileStoreContext(DrillConfig config, PersistentStoreProvider storeProvider,
    ...
    final PersistentStoreConfig<QueryProfile> persistentStoreConfig =
        PersistentStoreConfig.newProtoBuilder(SchemaUserBitShared.QueryProfile.WRITE,
...
//            .suggestedCapacity()
    ...
    try {
      completedProfiles = storeProvider.getOrCreateStore(persistentStoreConfig);
