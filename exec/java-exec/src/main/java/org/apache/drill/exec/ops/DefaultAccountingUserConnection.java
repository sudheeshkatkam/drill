 ...
 * sent to User.
 */
public class DefaultAccountingUserConnection implements AccountingUserConnection {
  private final UserClientConnection connection;
  private final SendingAccountor sendingAccountor;
  private final RpcOutcomeListener<Ack> statusHandler;

  public DefaultAccountingUserConnection(UserClientConnection connection, SendingAccountor sendingAccountor, RpcOutcomeListener<Ack> statusHandler) {
  ...
  public void sendData(final QueryWritableBatch batch) {
    sendData(statusHandler, batch);
  }

  @Override
  public void sendData(final RpcOutcomeListener<Ack> listener, final QueryWritableBatch batch) {
