...
public class ServerAuthenticationHandler<C extends ServerConnection, T extends EnumLite> implements RequestHandler<C> {
  ...
  void handleAuthFailure(final ServerConnection connection, final String remoteAddress, final ResponseSender sender,
                         final Exception e, final T saslResponseType) {
