...
public class FragmentDelegatingAccountingDataTunnel implements FragmentAccountingDataTunnel {
  private final FragmentAccountingDataTunnel delegate;
  private final RpcOutcomeListener<GeneralRPCProtos.Ack> listener;

  public FragmentDelegatingAccountingDataTunnel(final FragmentAccountingDataTunnel delegate,
  ...
  public static FragmentDelegatingAccountingDataTunnel of(final FragmentAccountingDataTunnel delegate,
                                                          final RpcOutcomeListener<GeneralRPCProtos.Ack> listener) {
    return new FragmentDelegatingAccountingDataTunnel(delegate, listener);
  }
}
