 ...
 * + must implement one constructor that takes DrillConfig as the only param
 * + must be annotated with SaslMechanism
 * + may throw DrillbitStartupException in case of any misconfiguration
 *
 * See PlainMechanism and KerberosMechanism as examples.
 */
