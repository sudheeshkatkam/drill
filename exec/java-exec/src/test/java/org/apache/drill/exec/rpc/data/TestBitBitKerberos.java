...
public class TestBitBitKerberos extends BaseTestQuery {
  ...
  public static void setupKdc() throws Exception {
    ...
    SERVER_PRINCIPAL = SERVER_SHORT_NAME + "/" + config.getString(ExecConstants.SERVICE_NAME) + "@" + REALM;
    ...
    newConfig = new DrillConfig(
        ...
        .withValue(ExecConstants.USE_CLUSTER_ID_AS_KERBEROS_INSTANCE_NAME,
            ConfigValueFactory.fromAnyRef(true))
  ...
  public void success(@Injectable WorkerBee bee, @Injectable final WorkEventBus workBus) throws Exception {
    ...
    BitConnectionConfigImpl config = new BitConnectionConfigImpl(c1.getAllocator(), c1,
