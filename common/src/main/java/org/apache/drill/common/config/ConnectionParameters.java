...
public final class ConnectionParameters {
   ...
   * @return params
   */
  public static ConnectionParameters createParamsFromProperties(final UserProperties userProperties) {
   ...
   * @return params
   */
  public static ConnectionParameters createParamsFromProperties(final Properties properties) {
    final Properties canonicalizedProperties = new Properties();
    if (properties != null) {
      for (final String key : properties.stringPropertyNames()) {
