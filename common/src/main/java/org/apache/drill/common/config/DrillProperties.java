...
public final class DrillProperties extends Properties {
  ...
  /**
   * Deserializes the given properties into DrillProperties, ignoring the ones not accepted by the server.
   *
  ...
  /**
   * Returns a new instance of DrillProperties from the given properties, ignoring the ones not allowed by the client.
   *
    ...
    if (properties != null) {
      for (final String key : properties.stringPropertyNames()) {
        ...
        if (ALLOWED_BY_CLIENT.contains(lowerCaseKey)) {
          drillProperties.setProperty(lowerCaseKey, value);
        } else {
