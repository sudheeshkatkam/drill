...
if (MSVC)
    ...
    if("${SASL_HOME}_" MATCHES  "^_$")
        ...
        find_path(SASL_INCLUDE_DIR sasl.h ${SASL_HomePath}/src/c/include)
        find_library(SASL_LIBRARY NAMES sasl PATHS ${SASL_LIB_PATHS})
    endif()
else()
    set(SASL_LIB_PATHS /usr/local/lib /opt/local/lib)
    find_path(SASL_INCLUDE_DIR sasl/sasl.h /usr/local/include)
    find_library(SASL_LIBRARY NAMES sasl2 PATHS ${SASL_LIB_PATHS})
endif()
